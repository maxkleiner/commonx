unit helpers.chart.fmx;
{$ERROR BAD}
interface

uses
  stringx, typex, classes, sysutils, debug,
  jsonhelpers,FMXTee.Canvas, FMXTee.Series,
  FMXTee.Chart;
...
function FindSeriesYValueByX(cs: FMXTee.Series.TChartClickSeries; xvalue: double): double;overload;
