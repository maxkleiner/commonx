...
{$ENDIF}
  ...
  public
    ...
    constructor CreateFromFile(ADXDraw: TCustomDXDraw; const FileName: ansistring);
  ...
  public                                    
    ...
    destructor Destroy; override;
    function Find(const Name: ansistring): TPictureCollectionItem;
    procedure Finalize;
...
var
  DirectDrawDrivers: TDirectXDrivers = nil;
...
procedure TDirectDrawPalette.LoadFromFile(const FileName: ansistring);
var
  Stream: TFileStream;
begin
...
procedure TDirectDrawSurface.LoadFromFile(const FileName: ansistring);
var
  Picture: TPicture;
begin
...
type
  ...
  function EnumDeviceCallBack(const lpGuid: TGUID; lpDeviceDescription, lpDeviceName: PAnsiChar;
...
type
  ...
  function EnumDeviceCallBack(lpDeviceDescription, lpDeviceName: PAnsiChar;
...
constructor TDirect3DTexture2.CreateFromFile(ADXDraw: TCustomDXDraw; const FileName: ansistring);
var
  Image: TObject;
begin
  Image := nil;
...
function TPictureCollection.Find(const Name: ansistring): TPictureCollectionItem;
var
  i: Integer;
begin
  i := IndexOf(Name);
...
procedure TPictureCollection.LoadFromFile(const FileName: ansistring);
var
  Stream: TFileStream;
begin
...
procedure TPictureCollection.SaveToFile(const FileName: ansistring);
var
  Stream: TFileStream;
begin
...
initialization
finalization
  if assigned(directdrawdrivers) then
    DirectDrawDrivers.Free;
end.
