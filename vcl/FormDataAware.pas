...
type
  ...
  public
    ...
    procedure AddDataLink(varType: integer; ds: TDataSet; sTableName: string; sField: string; obj: TComponent);
...
procedure TfrmDataAware.AddDataLink(varType: integer; ds: TDataSet; sTableName: string; sField: string; obj: TComponent);
var
  pd: PDatalink;
begin
