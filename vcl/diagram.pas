...
type
  ...
  private
    ...
    function GetPrimitive: string;virtual;
  protected
  ...
  public
    ...
    function CalcFullyQualifiedName: string;
    property FullyQualifiedName: string read CalcFullyQualifiedName write FName;
    ...
    procedure AddDocLine(sLine: string);

    property Responsibilities: TStringList read FResponsibilities;

    property Author: string read FAuthor write FAuthor;
    property DebugHTML: string read FDebug write FDebug;
    property DebugName: string read GetDebugName;
    property NameSpace: TNamespace read FNameSpace;
    property MetaOf: string read FMetaOf write FMetaOf;
    property Primitive: string read GetPrimitive;
  end;
  //----------------------------------------------------------------------------
...
//    property Name: string read FName write FName;
    ...
    property WebPage: string read FWebPage write FWebPage;
    property IntegrationPackage: string read FIntegrationPackage write FIntegrationPackage;
    property InType: string read FInType write FInType;
  ...
  private
    ...
    function GetPrimitive: string;override;
  public
  ...
  public
    property ReadFrom: string read FReadFrom write FReadFrom;
    property Writeto: string read FWriteTo write FWriteTo;
  end;
  ...
  public
    ...
    procedure TextByLine(x,y: integer; iLine: integer; sText: string; iBoxWidth :integer; iFontHeight: integer = CLASS_TEXT_HEIGHT; iLineSpace: integer = 13);
  ...
  public
    ...
    destructor Destroy; override;
    procedure Paintmain(dd: TdiagramDisplay; mr: TDiagramMemberRecord);override;
    procedure DrawCompartmentItem(dd: TdiagramDisplay; mr: TDiagramMemberRecord; iPosition: integer; sSignature: string);
    ...
    function AddMember(sName: string): TMemberDefinition;
...
(*  TStructure = class(TSquareSymbol)
  ...
  public
    ...
    //compartment items
    procedure DeleteItem(iIndex: integer);
    function AddItem(sName: string): TcompartmentItem; virtual;
    property Items[iIndex: integer]: TCompartmentItem read GetItems;
    property ItemCount: integer read GetItemCount;
  ...
  public
    ...
    function AddProperty(sName: string;comp: TObject = nil): TPropertyDefinition;
    ...
    function AddFunction(sName: string): TFunctionDefinition;
    function FindFunction(sName: string): TFunctionDefinition;
  ...
  protected
    ...
    function GetPrimitive: string;override;
  public
    property MatureType: string read FMatureType write FMatureType;
  ...
  //----------------------------------------------------------------------------
  TSymbolList = class(TFakeLockQueuedObject)
  private
  ...
  public
    ...
    function HasSymbol(sym: string): boolean;overload;
    function IndexOfSymbol(sym: TSymbol): integer;overload;
    function IndexOfSymbol(sym: string): integer;overload;
    function FindSymbol(sym: string): TSymbol;
    procedure Sort;
    procedure Clear;
  ...
  TDiagramList = class(TFakeLockQueuedObject)
  private
    FDiagrams: TList;
    FProject: TUMLProject;
  ...
  //----------------------------------------------------------------------------
  TUMLProject = class(TFakeLockQueuedObject)
  private
    ...
    function GetSourceFiles(idx: integer): string;
    function GetSourceFileCount: integer;
  public
    function GetErrors: IHolder<TStringlist>;
    ...
    property SourceFiles[idx: integer]: string read GetSourceFiles;
    property SourceFileCount: integer read GetSourceFileCount;
    procedure AddSourceFile(sFullName: string);
    procedure AddSourceDir(sPath, sFilter: string; bRecurse: boolean = true);

    procedure Compile(sFileName: string);
    procedure CompileAll;
    property Name: string read FName write FName;

    procedure QueueCompile(sFileNAme: string);
    procedure CompileQueue;

    function SymbolToUnitName(sSym: string): string;
...
function ProjectToXML(project: TUMLProject): string;
...
begin
  ...
  LockWrite;
  try
    existing := self.FindSymbol(sym.FullyQualifiedName);
...
{$IFDEF DETAILED_LOG}      debug.log('Adding '+sym.classname+':'+sym.name+' at '+FSymbols.count.tostring+' as child of '+self.ownername);{$ENDIF}
      FSymbols.Add(sym);
    end;
  finally
    UnlockWrite;
...
//------------------------------------------------------------------------------
function TSymbolList.FindSymbol(sym: string): TSymbol;
var
  i: integer;
begin
  LockRead;
...
//------------------------------------------------------------------------------
function TSymbolList.HasSymbol(sym: string): boolean;
begin
  LockRead;
  try
    result := IndexOfsymbol(sym) >= 0;
...
function TSymbolList.IndexOfSymbol(sym: string): integer;
var
  t: integer;
begin
  LockRead;
...
{ TProject }
//------------------------------------------------------------------------------
procedure TUMLProject.AddSourceDir(sPath, sFilter: string; bRecurse: boolean = true);
var
  dir: TDirectory;
  t: integer;
begin
...
procedure TUMLProject.AddSourceFile(sFullName: string);
begin
  LockString;
  try
...
procedure TUMLProject.Compile(sFileName: string);
var
  compiler: TCompiler;
  sym: Tsymbol;
  s: string;
  ...
  for t:= 0 to self.SourceFileCount-1 do begin
    ...
    try
      ...
      on E: Exception do begin
        log('Exception compiling '+sFile+'...'+e.message);
      end;
    end;
  end;
...
function TUMLProject.GetErrors: IHolder<TStringlist>;
begin
  result := THolder<TStringList>.create(CopyStringList(errors));

end;

//------------------------------------------------------------------------------
function TUMLProject.GetFileName: string;
begin
  result := FFileName;
end;
//------------------------------------------------------------------------------
...
function TUMLProject.GetSourceFiles(idx: integer): string;
begin
  LockString;
  try
...
//------------------------------------------------------------------------------
function TUMLProject.GetTitle: string;
begin
  LockString;
  try
    result := FTitle;
...
procedure TUMLProject.Log(sLog: string);
begin
  debug.Log(self,sLog,'diagramcompiler');

end;

procedure TUMLProject.QueueCompile(sFileNAme: string);
begin
...
//------------------------------------------------------------------------------
procedure TUMLProject.SetFileName(const Value: string);
begin
  FFileName := Value;
end;
//------------------------------------------------------------------------------
...
{ TSymbol }
//------------------------------------------------------------------------------
function TSymbol.CalcFullyQualifiedName: string;
begin
  result := name;//+'('+classname+')';
  if self.Parent <> nil then
    result := parent.CalcFullyQualifiedName+'.'+result;
...
function TSymbol.GEtParentName: string;
begin
...
function TSymbol.GetPrimitive: string;
begin
  result := 'symbol';
end;
...
var
  ci: TCompartmentItem;
begin
{$IFDEF DETAILED_LOG}debug.Log('Adding '+sNAme+' at index '+FItems.count.tostring);{$ENDIF}
...
function TLegacyRecord.AddMember(sName: string): TMemberDefinition;
begin
...
procedure TLegacyRecord.DrawCompartmentItem(dd: TdiagramDisplay;
  mr: TDiagramMemberRecord; iPosition: integer; sSignature: string);
begin
...
//------------------------------------------------------------------------------
procedure TDiagramDisplay.TextByLine(x,y: integer; iLine: integer; sText: string; iBoxWidth :integer; iFontHeight: integer = CLASS_TEXT_HEIGHT; iLineSpace: integer = 13);
var
  realy: integer;
begin
...
function TMatureConstruct.AddFunction(sName: string): TFunctionDefinition;
var
...
//------------------------------------------------------------------------------
function TMatureConstruct.AddProperty(sName: string;comp: Tobject = nil): TPropertyDefinition;
var
...
//------------------------------------------------------------------------------
function TMatureConstruct.FindFunction(sName: string): TFunctionDefinition;
var
  t: integer;
begin
  result := nil;
...
procedure TSymbol.AddDocLine(sLine: string);
begin
...
procedure TUMLProject.SetTitle(const Value: string);
begin
  LockString;
  try
    FTitle := Value;
...
function TUMLProject.SymbolToUnitName(sSym: string): string;
var
...
function TPropertyDefinition.GetPrimitive: string;
begin
  result := 'property';
end;
...
function TFunctionDefinition.GetPrimitive: string;
begin
  result := 'function';
end;
...
function TClassDefinition.GetPrimitive: string;
begin
  result := maturetype;
...
function TVariableSymbol.GetPrimitive: string;
begin
  result := 'variable';
end;
...
function TUnitDefinition.GetPrimitive: string;
begin
  result := 'unit';
end;
